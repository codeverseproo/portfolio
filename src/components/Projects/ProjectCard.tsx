...
export default function ProjectCard({ projectImg, projectTitle, gitURL }: TProjectCard) {
    const themeContext = useThemeContext();
    return (
        <div className="">
            <a href={gitURL} target="_blank" className="flex flex-col justify-center items-center gap-5 lg:hover:scale-105 transition-all duration-75">
